 ...
 */
const CATEGORY_SEARCH_INTENTS: Record<
  string,
  { swahili: string; keywords: string; desc: string }
> = {
  Televisions: {
    swahili: "Bei ya TV & Smart Televisions",
    keywords:
      "bei ya tv tanzania, smart tv bei nafuu dar es salaam, bei ya tv kariakoo, 4k smart tv tanzania, samsung tv tanzania, lg oled tv dar, tcl smart tv bei, hisense tv tanzania",
  ...
  Smartphones: {
    ...
    keywords:
      "bei ya simu tanzania, bei ya simu za samsung dar es salaam, bei ya iphone dar es salaam, nunua simu kariakoo, original smartphones tanzania, simu zenye warranty dar, redmi bei tanzania",
  ...
  "Laptops & Computers": {
    ...
    keywords:
      "bei ya laptop tanzania, nunua laptop dar es salaam, hp laptop tanzania, dell laptops kariakoo, macbook dar es salaam, laptop za ofisi na gaming tanzania, computer accessories dar",
  ...
  "Audio & Sound": {
    ...
    keywords:
      "soundbar bei tanzania, jbl bluetooth speaker dar es salaam, sony home theatre tanzania, wireless earbuds dar, bei ya spika kariakoo, subwoofers tanzania",
  ...
  "Home Appliances": {
    ...
    keywords:
      "bei ya friji tanzania, bei ya washing machine dar es salaam, majiko ya gesi na umeme tanzania, microwave oven kariakoo, blender bei dar es salaam, water dispenser tanzania",
  ...
  "Smart Watches": {
    ...
    keywords:
      "smartwatch tanzania, apple watch dar es salaam, samsung galaxy watch bei, fitness tracker dar es salaam, saa za kisasa kariakoo",
 ...
 */
export function generateAutoProductSEO(
  product: Product,
 ...
 */
export function generateAutoCategorySEO(
  categoryName: string,
  products: Product[] = [],
  settings?: Partial<StoreSettings>,
  origin = "https://genuine-electronics.com",
  ...
  const minPrice =
    matchingProducts.length > 0
      ...
      : 0;
  const priceSnippet =
    minPrice > 0 ? ` kuanzia TZS ${minPrice.toLocaleString()}` : "";
...
export function applyDynamicSEOMetadata(
  ...
  if (currentView === "admin") {
    ...
    const socialMeta = generateProductSocialMetadata(
    ...
    computedKeywords = generateAutoProductSEO(
      context.currentProduct,
      settings,
      currentOrigin,
    ).keywords;
    ...
    context?.searchQuery &&
    context.searchQuery.trim().length > 1 &&
    autoSeo
  ) {
    ...
    const catSEO = generateAutoCategorySEO(
      context.currentCategory,
      context.products || [],
      settings,
      currentOrigin,
    ...
    canonicalHref =
      settings.canonicalUrl && settings.canonicalUrl.trim() !== ""
  ...
  updateMetaTag(
    "property",
    "og:type",
    context?.currentProduct ? "product" : settings.ogType || "website",
  );
...
function injectFullSchemaOrgJSONLD(
  ...
  const graph: any[] = [
    // 1. Organization & Local Business Schema
    {
      ...
      paymentAccepted:
        "Cash, Credit Card, Bank Transfer, M-Pesa, Airtel Money, Mixx By Yas, Orbi Pay",
    },
