...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  const catMeta = categoriesList?.find(
    (c) =>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs mb-5 pb-5 border-b border-slate-100 dark:border-slate-700">
                  ...
                  {product.stock <= 0 ? (
                    <span className="text-rose-600 font-bold flex items-center gap-1">
                      <AlertCircle className="w-4 h-4" /> Out of Stock (0
                      available)
                    </span>
                  ) : (
                    ...
                    <div className="flex flex-wrap items-baseline justify-between gap-2">
                      ...
                      {product.isVatInclusive !== false && vatPercentage > 0 ? (
                        <span className="text-xs bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-bold px-3 py-1 rounded-full flex items-center gap-1">
                          ...
                          <span>
                            VAT Included ({vatPercentage}%) • Tax Invoice
                            Provided
                          </span>
                        </span>
                      ) : (
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-3 bg-slate-100 dark:bg-slate-900 p-1.5 rounded-xl border border-slate-200 dark:border-slate-700">
                    ...
                    <span className="font-extrabold text-sm text-slate-900 dark:text-white px-2">
                  ...
                  {product.stock <= 0 ? (
                    <button
                      onClick={() => {
                        ...
                        window.open(
                          `https://wa.me/255768929203?text=${encodeURIComponent(msg)}`,
                          "_blank",
                        );
                      }}
            ...
            {activeTab === "specs" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {Object.entries(product.specs).map(([key, val]) => (
                  <div
                    key={key}
                    className="bg-white dark:bg-slate-800 p-3.5 rounded-xl border border-slate-100 dark:border-slate-700/50 flex justify-between items-center text-xs"
                  >
            ...
            {activeTab === "warranty" && (
              <div className="space-y-4 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                <div className="bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 p-4 rounded-2xl flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-sm mb-1">
                      Official Manufacturer Backed Guarantee
                    </h4>
                    <p className="text-slate-700 dark:text-slate-300">
                      Every single unit sold by Genuine Electronics is sourced
                      directly from authorized manufacturers or licensed country
                      distributors. Your receipt includes official serial number
                      registration valid for direct authorized service across
                      Tanzania.
                    </p>
                  </div>
                </div>
                <ul className="list-disc list-inside space-y-1.5 pl-2 text-slate-700 dark:text-slate-200 font-medium">
                  ...
                  <li>
                    Free replacement within 7 days for any factory hardware
                    defect
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/50 text-xs">
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      "Ordered in the morning and received it before afternoon
                      in Masaki. Verified the serial code online immediately and
                      it came sealed in original packaging."
                    </p>
                  </div>
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/50 text-xs">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      "Excellent build quality and 100% genuine hardware. The
                      VoltBot AI assistant helped me check power compatibility
                      beforehand!"
                    </p>
                  </div>
                </div>
          ...
          {complementaryBundleItem && (
            <div className="bg-blue-50/70 dark:bg-slate-900/90 border border-blue-200/80 dark:border-slate-800 p-6 rounded-3xl space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div className="md:col-span-1 text-center font-extrabold text-slate-400 text-xl">
                  +
                </div>
                ...
                <div className="md:col-span-12 flex flex-wrap items-center justify-between pt-3 border-t border-blue-200/60 dark:border-slate-800 gap-4">
                  <div>
                    ...
                    <span className="text-base font-extrabold text-slate-900 dark:text-white ml-1">
              ...
              {fallbackSimilar.map((item) => (
                ...
                >
                  ...
                  <div className="pt-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between gap-2">
                    <span className="text-xs font-extrabold text-slate-900 dark:text-white break-words">
