...
export const TemplatePreview: React.FC<TemplatePreviewProps> = ({
  ...
  return (
    <div className="mt-6 border-t border-slate-200 dark:border-slate-800 pt-6">
      ...
      <div
        className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-inner"
        style={{ fontFamily: settings.fontFamily || "inherit" }}
      >
        {/* Announcement Bar Preview */}
        {settings.showAnnouncement && (
          <div
            className="text-white text-[10px] sm:text-xs font-medium py-2 px-4 text-center"
        ...
        <div
          className={`relative min-h-[300px] flex w-full overflow-hidden ${layout === "minimal" ? "bg-[#F4F7FB] dark:bg-slate-800" : layout === "bold" ? "bg-slate-900" : "bg-[#F4F7FB] dark:bg-slate-800"}`}
        >
          {layout === "split" && (
              ...
              <div className="max-w-sm relative z-10 space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-[11px] sm:text-xs leading-relaxed">
                  {settings.heroSubtitle ||
                    "Your subtitle description will appear here to provide more context to your customers."}
                </p>

                <div className="pt-2 flex gap-3">
                  <div
                    className="text-white text-[10px] font-bold px-4 py-2 rounded-full shadow-md"
                    style={{
                  ...
                  <div className="bg-white text-slate-900 text-[10px] font-bold px-4 py-2 rounded-full border border-slate-200 shadow-sm">
                    View Deals
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center text-center w-full p-6 sm:p-10 relative">
              <div className="max-w-xl relative z-10 space-y-5 flex flex-col items-center">
                ...
                <div className="pt-2 flex gap-3 justify-center">
                  <div
                    className="text-white text-[10px] font-bold px-6 py-2 rounded-full shadow-md"
                    style={{
                      backgroundColor: settings.primaryColor || "#2563eb",
                    }}
                  >
          ...
          {layout === "bold" && (
            <div className="relative flex items-center justify-center w-full min-h-[300px] p-6 sm:p-10">
              ...
              <div className="max-w-xl relative z-10 space-y-5 text-center flex flex-col items-center pt-8">
                ...
                <div className="pt-2 flex gap-3 justify-center">
                  <div className="bg-white text-slate-900 text-[10px] font-bold px-6 py-2.5 rounded-full shadow-lg">
                    Shop Collection
                  </div>
                </div>
              </div>
