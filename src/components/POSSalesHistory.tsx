...
const KNOWN_PAYMENT_CONFIGS = [
  {
    ...
    activeRing:
      "ring-2 ring-red-500 border-red-500 bg-red-500/5 dark:bg-red-950/30",
  ...
  },
  {
    ...
    activeRing:
      "ring-2 ring-rose-500 border-rose-500 bg-rose-500/5 dark:bg-rose-950/30",
  ...
  },
  {
    ...
    activeRing:
      "ring-2 ring-orange-500 border-orange-500 bg-orange-500/5 dark:bg-orange-950/30",
  ...
  },
  {
    ...
    activeRing:
      "ring-2 ring-emerald-500 border-emerald-500 bg-emerald-500/5 dark:bg-emerald-950/30",
  ...
  },
  {
    ...
    activeRing:
      "ring-2 ring-indigo-500 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-950/30",
  ...
  },
  {
    ...
    activeRing:
      "ring-2 ring-violet-500 border-violet-500 bg-violet-500/5 dark:bg-violet-950/30",
...
export const POSSalesHistory: React.FC<POSSalesHistoryProps> = ({
      ...
      .forEach((m) => {
        ...
        configs.push({
          ...
          matchTerms: [
            ...
            String(m?.accountName || "").toLowerCase(),
            String(m?.accountNumber || "").toLowerCase(),
          ],
          label: m.provider,
  ...
  const filteredTransactions = useMemo(() => {
    ...
    const targetLower = String(paymentMethodFilter || "")
      .toLowerCase()
      .trim();
  ...
  const paymentMethods = ["All", ...dynamicPaymentConfigs.map((c) => c.label)];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className={`text-xs mt-0.5 ${textSub}`}>
            View and audit offline counter sales, search cashiers, filter
            payment channels, and reprint receipts.
          </p>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3
              className={`text-xs font-black uppercase tracking-wider ${textTitle}`}
            >
              Payment Method Breakdown (
              {dateFilter === "All Time" ? "All Period" : dateFilter})
            </h3>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3">
          ...
          >
            <div>
              ...
              <p className={`text-[11px] font-extrabold mt-2 ${textTitle}`}>
                All Methods
              </p>
          ...
          {paymentBreakdownData.list.map((method) => {
            ...
            const pct =
              paymentBreakdownData.totalPeriodRevenue > 0
                ? Math.round(
                    (method.amount / paymentBreakdownData.totalPeriodRevenue) *
                      100,
                  )
                : 0;
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p
                    className={`text-[11px] font-extrabold mt-2 group-hover:text-blue-500 transition-colors ${textTitle}`}
                  >
                    {method.label}
                  </p>
                ...
                <div className="mt-3 pt-2 border-t border-slate-100 dark:border-slate-800/80 space-y-1.5">
                  <h4
                    className={`text-xs sm:text-sm font-black truncate ${method.amount > 0 ? textTitle : "text-slate-400 opacity-60"}`}
                  >
                  ...
                  <div className="w-full h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, Math.max(method.amount > 0 ? 5 : 0, pct))}%`,
                      }}
                    />
                  </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p
                className={`text-[10px] font-bold uppercase tracking-wider ${textSub}`}
              >
                Active Scope Revenue
              </p>
              <h3
                className={`text-base font-black mt-0.5 text-emerald-600 dark:text-emerald-400`}
              >
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  {formatToGMT3(viewingTx.createdAt)}
                </p>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
                ...
                <span className="font-bold">
                  {viewingTx.cashierName || "Admin"}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
                <span className="text-slate-400">Customer:</span>
                <span className="font-bold">
                  {viewingTx.customerName || "Walk-in"}
                </span>
              </div>
