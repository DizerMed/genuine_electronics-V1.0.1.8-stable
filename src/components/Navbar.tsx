...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  useEffect(() => {
    const checkPwaInstalled = () => {
      ...
      const installed =
        standalone || safeLocalStorage.getItem("ge_pwa_installed") === "true";
  ...
  const renderSearchDropdown = (
    ...
    return (
      <div
        className={`absolute left-0 right-0 top-full mt-2 rounded-2xl border shadow-2xl p-4 z-[90] animate-in fade-in slide-in-from-top-1 duration-150 ${
          isDark
              ...
              <button
                ...
                onMouseDown={(e) => {
                  ...
                  window.dispatchEvent(
                    new CustomEvent("nav-action", { detail: "shop" }),
                  );
                }}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span
                        className={`text-[10px] font-extrabold ${prod.stock && prod.stock > 0 ? "text-emerald-600 dark:text-emerald-400" : "text-rose-500"}`}
                      >
  ...
  useEffect(() => {
    const handleNavAction = (e: Event) => {
      ...
      if (
        ["home", "shop", "deals", "new-arrivals", "brands", "contact"].includes(
          customEvent.detail,
        )
      ) {
  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full transition-colors duration-200 font-sans`}
      style={{ fontFamily: storeSettings?.fontFamily || "inherit" }}
    >
      {/* Announcement Bar */}
      {storeSettings?.showAnnouncement && (
        <div
          className="text-white text-[11px] sm:text-xs font-semibold py-2 px-4 text-center shadow-sm w-full"
          style={{ backgroundColor: storeSettings?.primaryColor || "#0f172a" }}
        >
      ...
      <div
        className={`w-full backdrop-blur-md border-b transition-colors duration-200 ${
          isDark
            ? "bg-slate-950/95 border-slate-800/80 text-white shadow-md shadow-black/40"
            : "bg-white/95 border-slate-200/80 text-slate-900 shadow-sm"
        }`}
      >
        {/* Top Bar Row */}
        <div className="py-3 px-4 md:px-6 lg:px-10 xl:px-16 max-w-[1920px] mx-auto w-full flex items-center justify-between gap-4 md:gap-8">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col">
              <h1
                className={`text-lg md:text-xl font-black tracking-tight leading-none ${isDark ? "text-white" : "text-slate-900"}`}
              >
                Genuine<span className="text-blue-600 font-black">.</span>
              </h1>
              <span
                className={`text-[9px] md:text-[10px] font-extrabold tracking-[0.15em] uppercase mt-0.5 ${isDark ? "text-blue-400" : "text-blue-600"}`}
              >
                ELECTRONICS TRUST
              </span>
            </div>
          ...
          <div
            ...
            className="hidden md:block flex-1 max-w-xl lg:max-w-2xl relative"
          >
            <div
              className={`flex w-full rounded-full transition-all items-center border ${
                isDark
            ...
            >
              <Search
                className={`w-4 h-4 ml-4 shrink-0 ${isDark ? "text-slate-500" : "text-slate-400"}`}
              />
              <input
                type="text"
          ...
          <div className="flex items-center gap-2 md:gap-4 shrink-0">
            ...
            {!isStandalone && !isPwaInstalled && (
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-full text-xs font-bold transition-all border active:scale-95 ${
                  isDark
                    ? "bg-blue-950/70 hover:bg-blue-900 text-blue-300 border-blue-800/80"
            ...
            <div ref={userMenuRef} className="relative">
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs text-white font-extrabold shadow-sm transition-transform group-hover:scale-105 ${
                    user
                      ? "bg-gradient-to-tr from-blue-700 to-blue-500 ring-2 ring-blue-500/20"
                ...
                {user && (
                  <ChevronDown
                    className={`w-3.5 h-3.5 text-slate-400 transition-transform duration-200 ${showUserMenu ? "rotate-180 text-blue-600" : ""}`}
                  />
                )}
              </button>
              ...
              {showUserMenu && user && (
                <div
                  className={`absolute right-0 mt-2.5 w-64 rounded-2xl shadow-2xl border py-2 z-[70] animate-in fade-in slide-in-from-top-2 backdrop-blur-xl ${
                    isDark
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[10px] px-1.5 py-0.2 rounded-md bg-blue-500/10 text-blue-600 font-extrabold">
                      Live
                    </span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      onOpenProfile?.();
                      window.dispatchEvent(
                        new CustomEvent("nav-action", { detail: "profile" }),
                      );
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold transition-colors ${
                      isDark
        ...
        <div
          ref={mobileSearchRef}
          className="md:hidden px-4 pb-3 pt-0 relative"
        >
          <div
            className={`flex w-full rounded-full transition-all items-center border ${
              isDark
        ...
        <div
          className={`hidden md:block border-t relative transition-colors ${
            isDark
          ...
          <div className="flex items-center px-3 sm:px-6 lg:px-10 xl:px-16 max-w-[1920px] mx-auto w-full">
            ...
            >
              <div
                ...
                onClick={() =>
                  window.dispatchEvent(
                    new CustomEvent("nav-action", { detail: "categories" }),
                  )
                }
              >
              ...
              <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <div
                  className={`w-[480px] sm:w-[560px] rounded-2xl shadow-2xl border p-5 ${
                    isDark
                ...
                >
                  <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-100 dark:border-slate-800">
                    <span className="text-xs font-extrabold tracking-wider text-blue-600 dark:text-blue-400 uppercase">
                      Shop by Category
                    </span>
            ...
            <nav
              className={`flex items-center gap-5 sm:gap-8 text-[10px] sm:text-xs font-bold capitalize tracking-wider min-w-max pr-4 ${
            ...
            >
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div
                    className={`w-[720px] lg:w-[840px] rounded-2xl shadow-2xl border p-5 ${
                      isDark
                        ? "bg-slate-950 border-slate-800 text-white"
                        : "bg-white border-slate-100 text-slate-900"
                    }`}
                            ...
                            <div
                              ...
                              className={`p-2.5 rounded-xl border transition-all duration-200 cursor-pointer group hover:-translate-y-0.5 ${
                                isDark
                                  ...
                                  : "bg-slate-50 border-slate-200/80 hover:border-blue-500 hover:bg-white shadow-xs"
                              }`}
                            >
                              <div className="w-full h-24 rounded-lg overflow-hidden mb-2 bg-white flex items-center justify-center p-1 relative">
                                ...
                                />
                                <span className="absolute top-1 right-1 px-1.5 py-0.5 bg-blue-600 text-white text-[9px] font-black rounded-md">
                                  GENUINE
                                </span>
                              </div>
              ...
              <div className="relative group">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.dispatchEvent(
                      new CustomEvent("nav-action", { detail: "deals" }),
                    );
                  }}
                ...
                <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div
                    className={`w-[640px] rounded-2xl shadow-2xl border p-5 ${
                      isDark
                        ? "bg-slate-950 border-slate-800 text-white"
                        : "bg-white border-slate-100 text-slate-900"
                    }`}
                  >
                    <div className="grid grid-cols-12 gap-5">
                      ...
                      <div className="col-span-7 pl-1">
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100 dark:border-slate-800">
                          <span className="text-xs font-extrabold tracking-wider text-rose-500 uppercase">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {products.slice(0, 2).map((prod) => (
                            <div
                              ...
                              className={`p-2.5 rounded-xl border transition-all duration-200 cursor-pointer group hover:-translate-y-0.5 ${
                                isDark
                                  ? "bg-slate-900/80 border-slate-800 hover:border-rose-500"
                                  : "bg-slate-50 border-slate-200/80 hover:border-rose-500 hover:bg-white shadow-xs"
                              }`}
                            >
                              <div className="w-full h-24 rounded-lg overflow-hidden mb-2 bg-white flex items-center justify-center p-1 relative">
                                <img
                                  ...
                                  className="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform duration-300"
                                />
                                <span className="absolute top-1 left-1 px-1.5 py-0.5 bg-rose-600 text-white text-[9px] font-black rounded-md">
                                  HOT
                                </span>
                              </div>
              ...
              <div className="relative group">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.dispatchEvent(
                      new CustomEvent("nav-action", { detail: "new-arrivals" }),
                    );
                  }}
                ...
                <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  >
                    <div className="grid grid-cols-12 gap-5">
                      ...
                      <div className="col-span-7 pl-1">
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100 dark:border-slate-800">
                          <span className="text-xs font-extrabold tracking-wider text-emerald-500 uppercase">
                            Newly Added Units
                          </span>
                          <button
                            onClick={() =>
                            ...
                            <div
                              ...
                              className={`p-2.5 rounded-xl border transition-all duration-200 cursor-pointer group hover:-translate-y-0.5 ${
                                isDark
                                  ...
                                  : "bg-slate-50 border-slate-200/80 hover:border-emerald-500 hover:bg-white shadow-xs"
                              }`}
                            >
                              <div className="w-full h-24 rounded-lg overflow-hidden mb-2 bg-white flex items-center justify-center p-1 relative">
                                <img
                                  ...
                                  className="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform duration-300"
                                />
                                <span className="absolute top-1 right-1 px-1.5 py-0.5 bg-emerald-600 text-white text-[9px] font-black rounded-md">
                                  NEW
                                </span>
                              </div>
              ...
              <div className="relative group">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.dispatchEvent(
                      new CustomEvent("nav-action", { detail: "brands" }),
                    );
                  }}
                ...
                <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div
                    className={`w-[520px] rounded-2xl shadow-2xl border p-5 ${
                      isDark
                        ? "bg-slate-950 border-slate-800 text-white"
                        : "bg-white border-slate-100 text-slate-900"
                    }`}
              ...
              <div className="relative group">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.dispatchEvent(
                      new CustomEvent("nav-action", { detail: "contact" }),
                    );
                  }}
                ...
                <div className="absolute top-full left-0 mt-0 pt-2 hidden group-hover:block z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div
                    className={`w-[480px] rounded-2xl shadow-2xl border p-5 ${
                      isDark
                        ? "bg-slate-950 border-slate-800 text-white"
                        : "bg-white border-slate-100 text-slate-900"
                    }`}
                  >
                    <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100 dark:border-slate-800">
                      <span className="text-xs font-extrabold tracking-wider text-blue-500 uppercase">
                    ...
                    <div className="flex flex-col gap-2">
                      <div
                        ...
                        className={`p-3 rounded-xl border text-xs font-bold cursor-pointer transition-all flex items-center justify-between ${
                          isDark
                            ...
                            : "border-slate-200 bg-slate-50 hover:bg-white hover:border-blue-500"
                        }`}
                      >
                      ...
                      >
                        ...
                        <span className="text-[10px] text-blue-500 font-extrabold">
