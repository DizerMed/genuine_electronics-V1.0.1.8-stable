...
export const AdminShortcutCheatSheetModal: React.FC<
  AdminShortcutCheatSheetModalProps
> = ({ isOpen, onClose, isDark = true }) => {
      ...
      items: [
        {
          ...
          description:
            "Opens new inventory form with auto-generated SKU & Barcode",
        ...
        },
        {
          ...
          description:
            "Saves current store configuration, SEO tags, or active form",
        ...
        },
        {
          ...
          description:
            "Instant search & jump across catalog, orders, POS, and settings",
        ...
        },
        {
          ...
          description:
            "Opens interactive camera scanner for stock and POS checkouts",
        ...
        },
        {
          ...
          description:
            "Dismisses open dialogs, forms, scanners, and command palettes",
      ...
      items: [
        {
          ...
          description:
            "Press Shift + ? or click shortcut button anywhere in Admin",
        ...
        >
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              >
                Navigate the Genuine Electronics Admin Portal with rapid
                single-stroke keystrokes.
              </p>
            </div>
          </div>
          <button
                ...
                {group.items.map((item, iIdx) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div
                        className={`p-2 rounded-xl border shrink-0 shadow-xs flex items-center justify-center ${getColorClasses(item.colorScheme)}`}
                      >
                        {item.icon}
                      </div>
        ...
        >
          <span className="flex items-center gap-1.5">
            ...
            <span className="font-medium">
              Shortcuts are active across all admin screens & POS modules.
            </span>
          </span>
          <button
            onClick={onClose}
