    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <kbd
            className={`px-2 py-0.5 text-[10px] font-mono font-bold rounded-lg border shrink-0 ${
              isDark
        ...
        <div
          ref={listRef}
          className="p-2 overflow-y-auto max-h-[60vh] space-y-1"
        >
          {filteredItems.length === 0 ? (
            <div className="p-8 text-center text-slate-500 space-y-2">
              ...
              <p className="text-xs">
                Try searching for a different command or product name
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {item.subtitle && (
                        <div
                          className={`text-[11px] truncate ${isSelected ? "text-white/80" : isDark ? "text-slate-400" : "text-slate-500"}`}
                        >
                          {item.subtitle}
                        </div>
                      )}
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <ArrowRight
                      className={`w-4 h-4 transition-transform ${isSelected ? "translate-x-0.5 opacity-100" : "opacity-0"}`}
                    />
                  </div>
                </div>
              );
